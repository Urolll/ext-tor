...
/* package ext-tor-0.1.0.0 */
#ifndef VERSION_ext_tor
#define VERSION_ext_tor "0.1.0.0"
#endif /* VERSION_ext_tor */
#ifndef MIN_VERSION_ext_tor
#define MIN_VERSION_ext_tor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ext_tor */
...
#define CURRENT_PACKAGE_KEY "ext-tor-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "ext-tor-0.1.0.0-inplace"
